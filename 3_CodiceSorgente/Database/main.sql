...
CREATE TABLE CorrezioneItinerario
(
	authorId text,
	itinerarioId bigint,
	durata integer,
	difficolta difficoltaItinerario,
	CONSTRAINT CORREZIONEITINERARIO_PK PRIMARY KEY(authorId, itinerarioId),
	CONSTRAINT CORREZIONEITINERARIO_FK_ITINERARIOID FOREIGN KEY (itinerarioId) REFERENCES Itinerario(id),
	CONSTRAINT CORREZIONEITINERARIO_FK_AUTHORID FOREIGN KEY (authorId) REFERENCES Utente(email),
	CONSTRAINT CORREZIONEITINERARIO_NOT_NULL CHECK ((durata IS NOT NULL) OR (difficolta IS NOT NULL))
);	